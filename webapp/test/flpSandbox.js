		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Order",
									"targetURL": "#comsapsalesoderlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapsalesoderlist-display": {
								"semanticObject": "comsapsalesoderlist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.salesoderlist",
									"url": sap.ui.require.toUrl("com/sap/salesoderlist")
								}
							}
						}
					}
